  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex justify-center">
        <Link
          href="/analytics"
          className="group relative inline-flex items-center gap-2 overflow-hidden rounded-lg border border-purple-500/20 bg-gradient-to-r from-purple-500/10 to-pink-500/10 px-6 py-3 text-sm font-medium shadow-sm transition-all hover:shadow-md hover:from-purple-500/20 hover:to-pink-500/20"
        >
