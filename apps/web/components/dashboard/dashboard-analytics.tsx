  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex justify-center">
        <Link
          href="/analytics"
          className="group relative inline-flex items-center gap-2 overflow-hidden rounded-lg border border-primary/20 bg-primary/5 px-6 py-3 text-sm font-medium shadow-sm transition-all hover:shadow-md hover:bg-primary/10"
        >
